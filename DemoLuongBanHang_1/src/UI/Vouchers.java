...
public class Vouchers extends javax.swing.JPanel {
    ...
    public void showData() {
        ...
        if (row >= 0) {
            ...
            txtsoluong.setText(tblbangvoucher.getValueAt(row, 3).toString());
            txtgiatri.setText(tblbangvoucher.getValueAt(row, 4).toString());
            try {
...
//    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons/Zoom.png"))); // NOI18N
        ...
        tblbangvoucher.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Voucher", "Tên Voucher", "Số Lượng", "Giá trị", "Ngày bắt đầu", "Ngày kết thúc", "Trạng Thái"
            }
        ) {
...
//        SimpleDateFormat fomat = new SimpleDateFormat("yyyy-MM-dd");
//        try {
//            Date Date_of_Birth = fomat.parse(fomat.format(datebatdau.getDate()));
//            Date Today_Date = fomat.parse(fomat.format(dateketthuc.getDate()));
//            new Timer(1000, new ActionListener() {
//                public void actionPerformed(ActionEvent e) {
//                    LocalDate HomNay = LocalDate.now();
//                    long Datediff = HomNay.toEpochDay() - Today_Date.getTime();
//                    long hours = Datediff / (60 * 60 * 1000);
//                    long minutes = hours * 60;
//                    txttrangthai.setText(Long.toString(hours));
//                    if (minutes >= 0) {
